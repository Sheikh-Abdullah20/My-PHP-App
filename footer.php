<footer>
    <div class="container-fluid bg-light">
        <div class="row  ">
            ...
            <div class="col-6 d-flex justify-content-center text-center">
                <ul>
                    <h4 class='display-6'>Social Links</h4>
